...
# ✅ Cache NDK + CMake (optional but improves performance)
...
# 🎯 Build APK if commit message contains [apk]
...
# ⚡ Upload APK directly to Firebase (no artifact storage)
...
# 🎯 Build AAB if commit message contains [aab]
...
# 🎯 Build both if commit message contains [both]
