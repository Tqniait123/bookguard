...
class _SubscriptionsPageState extends State<SubscriptionsPage> {
  ...
  List<PlanModel> plans = [PlanModel(id: 1, name: 'asas', price: 299, duration: 3), PlanModel(id:2, name: 'vvv', price: 299, duration: 5), PlanModel(id: 3, name: 'ooo', price: 299, duration: 7)];
